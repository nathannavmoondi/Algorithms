		...
		return new Promise((resolve) => {
			...
			if (this.isAmpProject || this.isAmpIframe) {
				...
				var urlDetObj = new SekindoClientDetections_URL({
					url: 'https://live.primis.tech/live/liveView.php?s=109366&cbuster=%%CACHEBUSTER%%&cbuster=1720710854',
					origQString: 's=109366&cbuster=%%CACHEBUSTER%%',
					placementId: 109366,
					x: 690,
					y: 230,
					videoType: 'flow',
					...
					isAPI: false,
					debug: 0,
					ci: {"extra":{"schemaVer":"11","os":"Windows","osVersion":"10.0","osVersionMajor":"10","osVersionMinor":"0","deviceManufacturer":"","deviceModel":"","deviceCodeName":"","deviceType":"desktop","browser":"Chrome","browserType":"browser","browserVersion":"126.0.0.0","browserVersionMajor":"126","browserVersionMinor":"0","chromeVersion":"126"},"browser":"chrome","os":"windows","osVer":"","deviceType":"desktop","languages":["en"],"googlePSI":false},
					isFpCookie: 0,
					geo: 'CA',
					dmaCode: 0,
					dynamicSetup: [],
