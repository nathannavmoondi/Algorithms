...
//one index, and the last element of the array is moved to the first place. 
...
function solution1(arr, rotation){
    ...
    for (let i = 0; i < rotation; i++){
        ...
        let rightvalue = newarr[newarr.length-1]
...
console.log(solution1([3, 8, 9, 7, 6], 3)); //return [9, 7, 6, 3, 8]
